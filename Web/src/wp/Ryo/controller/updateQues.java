...
public class updateQues extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/UpdateQues.jsp").forward(request, response);		
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			else
			{
				...
				request.getRequestDispatcher("/WEB-INF/UpdateQues.jsp?MaCauHoi="+questionId).forward(request, response);
			}
		}
		catch (Exception e) {
			//thông báo thất bại
