...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div class="my-container">
		...
		<sql:query dataSource="${data}" var="result">
	         	select * from vinfouser where MSND=?;
	         	<sql:param value="${MSND}"/>
	         	</sql:query>
        
        <div class="my-info" style="margin-bottom: 15%">
        	<c:forEach var="row" items="${result.rows}">
            <form action="capnhapUser" method="post">
                <h1 style="text-align: center;color:blue">Thông tin thành viên</h1>
                <div class="inline-block">           
                    <div class="form-group">
                        <label for="usrname"><span class="glyphicon glyphicon-user"></span> Tên đăng nhập</label>
                        <input type="text" name = "u_username" class="form-control user" id="username myText" value="${row.MSND}" disabled style="width: 65%">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="psw">Mã quyền truy cập</label>
                        <input type="text" name = "u_role" class="form-control" id="role myText" value="${row.MaQuyen}" disabled style="width: 65%">
                    </div>
                    <div class="form-group">
                        <label for="psw">Họ tên</label>
                        <input type="text" name = "u_fullname" class="form-control" id="fullname myText" value="${row.HoTen}" disabled style="width:100%">
                    </div>
                </div>

                <div class="inline-block">
                    <div class="form-group">
                        <label for="usrname">Mã khoa</label>
                        <input type="text" name = "username" class="form-control user" id="department myText" value="15110168" disabled style="width: 80%">
                    </div>
                    <div class="form-group">
                        <label for="usrname">Mã lớp</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name = "username" class="form-control" id="email myText" value="" disabled style="width: 110%">
                    </div>
                </div>
