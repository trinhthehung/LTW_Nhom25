            ...
            <div>
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="trangsinhvien"><span class="glyphicon glyphicon-user"></span> Student. ${name}</a></li>
